...
from core.colors import end, green, white, bad, info
...
try:
    ...
    try:
        ...
        if(ret_code != 0):
            ...
            quit()
        print ('%s fuzzywuzzy has been installed, restart XSS Finder.' % info)
        quit()
except ImportError:  # throws error in python2
    print('%s XSS Finder isn\'t compatible with python2.\n Use python > 3.4 to run XSS Finder.' % bad)
    quit()
